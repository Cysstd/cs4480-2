# My_Project/python/sequential_scraper.py
# Description: Scrapes keywords one by one. Establishes the baseline performance.
...
if __name__ == "__main__":
    print("--- Experiment 1: Sequential Scraping ---")
    start_time = time.time()
    
    all_images_data = []
    for keyword in SEARCH_KEYWORDS:
        results = scrape_keyword_worker(keyword)
        all_images_data.extend(results)
    ...
    print("\n-----------------------------------------")
    print(f"✅ Sequential scraping finished in {end_time - start_time:.2f} seconds.")
