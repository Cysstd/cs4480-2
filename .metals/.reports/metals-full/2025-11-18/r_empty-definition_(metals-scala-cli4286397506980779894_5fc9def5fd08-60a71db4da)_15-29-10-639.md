error id: file://<WORKSPACE>/spark/spark_preprocess.sc:
...
```scala
///> using scala 3.7.4
//> using dep org.apache.spark::spark-sql:4.0.0-preview1
//> using dep org.apache.spark::spark-core:4.0.0-preview1
//> using spark
